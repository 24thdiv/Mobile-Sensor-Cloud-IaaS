...
<% 
    ...
    <div id="wrapper">
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a class="active" href="Admindata"><i class="fa fa-dashboard fa-fw"></i> Dashboard</a>
                        </li>
                       
                        <li> 
                            <a href="userstable"><i class="fa fa-table fa-fw"></i> Users</a>
                        </li>
                      
                        <li> 
                            <a href="Billings"><i class="fa fa-table fa-fw"></i> Billing</a>
                        </li>
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Sensors of Hub ${sessionScope.hub_id}</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
           ...
           <table class="table table-striped table-bordered table-hover">
           	<thead>
           		...
           		<t:forEach items="${sessionScope.hubdetails}"  var="tb">
           		<tr>
           		<td>${tb.sensor_tag_value }</td>
           		<td>${tb.user_id }</td>
           		<td>${tb.sensor_status }</td>
           		<td>${tb.date }</td>
           		</tr>
           		</t:forEach>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h3 class="page-header">Utilization of Sensors</h3>
                </div>
                <!-- /.col-lg-12 -->
            </div>

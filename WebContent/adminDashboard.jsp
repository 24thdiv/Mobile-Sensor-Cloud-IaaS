...
<body background="https://www.colourbox.com/preview/2347548-weather-icons-doodles-hand-drawn-set-on-white.jpg">
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <!-- /.row -->
<t:forEach items="${sessionScope.hub}"  var="row">  
                            ...
                            <div class="row">
                              <!--   <div class="col-xs-3">
                                ...
                                <div class="col-xs-9 text-right">
                                    <div class="huge">${row.hub_id }</div>
                                    <div>Hub ID</div>
                                </div>
                            </div>
                        </div>
                        <a href="hubDetails?id=${row.hub_id }">
                    ...
                    <div class="panel panel-green">
                        <div class="panel-heading">
                            ...
                            <!--  
                                ...
                                -->
                                <div class="col-xs-9 text-right">
                                    <div class="huge">${row.no_of_server}</div>
                                    <div>Sensors Allocated</div>
                                </div>
                            </div>
                        </div>
                        <a href="hubDetails?id=${row.hub_id }">
                    ...
                    <div class="panel panel-yellow">
                        <div class="panel-heading">
                            ...
                            <!--      <div class="col-xs-3">
                                ...
                                -->
                                <div class="col-xs-9 text-right">
                                    <div class="huge">${row.hub_status}</div>
                                    <div>Health</div>
                                </div>
                            </div>
                        </div>

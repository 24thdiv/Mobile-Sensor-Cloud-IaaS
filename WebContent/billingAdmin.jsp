...
<body background="https://www.colourbox.com/preview/2347548-weather-icons-doodles-hand-drawn-set-on-white.jpg">
    ...
    <div id="wrapper">
                ...
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                       ...
                       <li>
                        ...
                        <li> 
                            <a class="active" href="#"><i class="fa fa-table fa-fw"></i> Billing</a>
                        </li>
                    </ul>
                </div>
                <!-- /.sidebar-collapse -->
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Each Sensors Bills</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
 ...
 <!-- <t:forEach items="${sessionScope.sensor}"  var="row">            
           ...
           <table class="table table-striped table-bordered table-hover">
           	<thead>
           		...
           		<t:forEach items="${sessionScope.billings}"  var="tb">
           		<tr>
           		<td>${tb.sensor_id }</td>
           		<td>${tb.user_id }</td>
           		<td>${tb.up_time }</td>
           	    ...
           	    <td></td>
           	    <td></td>
           	    <td>$<t:out value="${sessionScope.totals }"></t:out></td>
           		</tr>
           </table>
           </div>
            <!-- <div class="row">

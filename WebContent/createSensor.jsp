...
function initialize() {
    var centerPosition = new google.maps.LatLng(37.33495, -121.88198);
    var options = {
        zoom: 9,
    ...
    google.maps.event.addListener(map, 'click', function (evt) {
        placeMarker(evt.latLng);
         ...
         document.getElementById("lon").value = evt.latLng.lng().toFixed(5);
    });
}
                ...
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                       ...
                       <!--  <li>
                        ...
                        <li>
                            <a class="active" href="#"><i class="fa fa-edit fa-fw"></i>Subscribe Sensor</a>
                        </li>
                         <li>
		...
		<form action = "CreateSensor" method="GET" name="locationname">
			<div id="page-wrapper">
				<div class="row">
					...
					<div class="col-lg-2">
					<br>
						<input type="submit" class="btn btn-primary" Value="Subscribe Sensor"></input>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Select Location and Provide Sensor Name
                        </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
                            
                           <div id="googleMap" style="width:1195px;height:550px;" ></div>
